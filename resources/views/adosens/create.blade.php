...
@section('title', 'Admin | Form Tambah Data Dosen')
...
<div class="container">
    <div class="row">
        <div class="col-8">            
            <h3 class = "mt-3">Form Tambah Data Dosen</h3>
            
                <form method="post" action="/adosens"><br>
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jk') is-invalid @enderror" id="jk" placeholder="P/L" name="jk" value="{{ old('jk') }}">
                        @error('jk')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror

                    <div class="mb-3">
                        <label for="dosen_matkul" class="form-label">Dosen Mata Kuliah</label>
                        <input type="text" class="form-control" id="dosen_matkul" name="dosen_matkul" value="{{ old('dosen_matkul') }}">
                    </div>

...
@section('title', 'Admin | Show Dosen')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <a href="/adosens/create" class="btn btn-primary my-3">Tambah Data Dosen</a>
            ...
            <ul class="list-group">
                @foreach ($adosens as $adnosen)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnosen -> nama}}
                  <a href="/adosens/{{ $adnosen -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

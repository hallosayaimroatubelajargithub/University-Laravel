...
@section('title', 'Admin | Form Tambah KHS')
...
<div class="container">
    <div class="row">
        <div class="col-8">            
            <h3 class = "mt-3">Form Tambah KHS</h3>
            
                <form method="post" action="/adkhs"><br>
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('sks') is-invalid @enderror" id="sks" name="sks" value="{{ old('sks') }}">
                        @error('sks')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror
                    <br>
                    <div class="mb-3">
                        <label for="grade_huruf" class="form-label">Grade</label>
                        <input type="text" class="form-control @error('grade_huruf') is-invalid @enderror" id="grade_huruf" name="grade_huruf" value="{{ old('grade_huruf') }}">
                        @error('grade_huruf')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror
                    <br>
                    <div class="mb-3">
                        <label for="ipk" class="form-label">IPK</label>
                        <input type="text" class="form-control @error('ipk') is-invalid @enderror" id="ipk" name="ipk" value="{{ old('ipk') }}">

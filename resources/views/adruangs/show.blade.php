...
@section('title', 'Admin | Detail Ruang')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            <h3 class = "mt-3">Detail Ruangan</h3>
            
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Penanggung Jawab  : {{$adruangs->penanggung_jawab}}</h5>
                  
                  <a href="{{ $adruangs->id }}/edit" class="btn btn-primary">Edit</a>
                  <form action="/adruangs/{{ $adruangs->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
                    <button type="submit" class="btn btn-danger">Delete</button>
                  </form>
                  <a href="/adruangs" class="btn btn-warning">Kembali</a>
                </div>
              </div>

...
@section('title', 'Admin | Show Data Gedung')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <a href="/adgedungs/create" class="btn btn-primary my-3">Tambah Daftar Gedung</a>
            ...
            <ul class="list-group">
                @foreach ($adgedungs as $adngedungs)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adngedungs -> id}}
                  <a href="/adgedungs/{{ $adngedungs -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

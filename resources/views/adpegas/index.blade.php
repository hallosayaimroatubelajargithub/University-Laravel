...
@section('title', 'Admin | Show Pegawai')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <a href="/adpegas/create" class="btn btn-primary my-3">Tambah Data Pegawai</a>
            ...
            <ul class="list-group">
                @foreach ($adpegas as $adnpega)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnpega -> nama}}
                  <a href="/adpegas/{{ $adnpega -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

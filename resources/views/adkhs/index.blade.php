...
<div class="container">
    <div class="row">
        <div class="col-6">            
            <h3 class = "mt-3">Daftar KHS</h3>
            <a href="/adkhs/create" class="btn btn-primary my-3">Tambah KHS</a>
            ...
            <ul class="list-group">
                @foreach ($adkhs as $adnkhs)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnkhs -> id_mhs}}
                  <a href="/adkhs/{{ $adnkhs -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

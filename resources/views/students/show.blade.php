        ...
        <div class="col-6">            
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Tempat, Tgl Lahir : {{$students->ttl}}</p>
                  <p class="card-text">Agama             : {{$students->agama}}</p>
                  <p class="card-text">Alamat            : {{$students->alamat}}</p>
                  <p class="card-text">Fakultas          : {{$students->fak}}</p>
                  <p class="card-text">Program Studi     : {{$students->prodi}}</p>
                  <p class="card-text">Semester          : {{$students->smstr}}</p>

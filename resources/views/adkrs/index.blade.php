...
<div class="container">
    <div class="row">
        <div class="col-6">            
            <h3 class = "mt-3">Daftar KRS</h3>
            <a href="/adkrs/create" class="btn btn-primary my-3">Tambah KRS</a>
            ...
            <ul class="list-group">
                @foreach ($adkrs as $adnkrs)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnkrs -> id_mhs}}
                  <a href="/adkrs/{{ $adnkrs -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

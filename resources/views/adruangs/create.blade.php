...
@section('title', 'Admin | Form Tambah Ruang')
    ...
    <div class="row">
        <div class="col-8">            
            <h3 class = "mt-3">Form Tambah Ruangan</h3>
                ...
                <form method="post" action="/adruangs"><br>
                    @csrf
                    <div class="mb-3">
                        <label for="penanggung_jawab" class="form-label">Penanggung Jawab</label>
                        <input type="text" class="form-control @error('penanggung_jawab') is-invalid @enderror" id="penanggung_jawab" placeholder="Masukkan Nama Penanggung Jawab" name="penanggung_jawab" value="{{ old('penanggung_jawab') }}">

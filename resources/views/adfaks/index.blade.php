...
@section('title', 'Admin | Show Fakultas')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            <h3 class = "mt-3">Daftar Fakultas</h3>
            <a href="/adfaks/create" class="btn btn-primary my-3">Tambah Fakultas</a>
            ...
            <ul class="list-group">
                @foreach ($adfaks as $adnfak)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnfak -> nama}}
                  <a href="/adfaks/{{ $adnfak -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

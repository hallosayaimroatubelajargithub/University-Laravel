...
@section('title', 'Admin | Show Prodi')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <a href="/adprodis/create" class="btn btn-primary my-3">Tambah Program Studi</a>
            ...
            <ul class="list-group">
                @foreach ($adprodis as $adnprodi)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnprodi -> nama}}
                  <a href="/adprodis/{{ $adnprodi -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

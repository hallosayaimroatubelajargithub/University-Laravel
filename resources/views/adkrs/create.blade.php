...
@section('title', 'Admin | Form Tambah KRS')
...
<div class="container">
    <div class="row">
        <div class="col-8">            
            <h3 class = "mt-3">Form Tambah KRS</h3>
            
                <form method="post" action="/adkrs"><br>
                    @csrf
                    <div class="mb-3">
                        <label for="id_mhs" class="form-label">ID Mahasiswa</label>
                        <input type="text" class="form-control @error('id_mhs') is-invalid @enderror" id="id_mhs" placeholder="Masukkan ID Mahasiswa" name="id_mhs" value="{{ old('id_mhs') }}">
                        @error('id_mhs')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror
                    <br>
                    <div class="mb-3">
                        <label for="id_matkul" class="form-label">ID Mata Kuliah</label>
                        <input type="text" class="form-control @error('id_matkul') is-invalid @enderror" id="id_matkul" placeholder="Masukkan ID Matkul" name="id_matkul" value="{{ old('id_matkul') }}">
                        @error('id_matkul')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror
                    <br>
                    <div class="mb-3">
                        <label for="nama_matkul" class="form-label">Nama Mata Kuliah</label>
                        <input type="text" class="form-control @error('nama_matkul') is-invalid @enderror" id="nama_matkul" placeholder="Masukkan Nama Matkul" name="nama_matkul" value="{{ old('nama_matkul') }}">
                        @error('nama_matkul')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror
                    <br>
                    <div class="mb-3">
                        <label for="id_dosen" class="form-label">ID Dosen</label>
                        <input type="text" class="form-control @error('id_dosen') is-invalid @enderror" id="id_dosen" name="id_dosen" value="{{ old('id_dosen') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('pukul') is-invalid @enderror" id="pukul" name="pukul" value="{{ old('pukul') }}">
                        @error('pukul')<div class="invalid-feedback"> {{ $message }}</div>
                    </div>@enderror
                    <br>
                    <div class="mb-3">
                        <label for="id_ruang" class="form-label">ID Ruang</label>
                        <input type="text" class="form-control @error('id_ruang') is-invalid @enderror" id="id_ruang" name="id_ruang" value="{{ old('id_ruang') }}">

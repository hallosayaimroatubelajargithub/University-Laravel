...
@section('title', 'Admin | Show Matkul')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <a href="/admatkuls/create" class="btn btn-primary my-3">Tambah Data Mata Kuliah</a>
            ...
            <ul class="list-group">
                @foreach ($admatkuls as $adnmatkul)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnmatkul -> nama}}
                  <a href="/admatkuls/{{ $adnmatkul -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

...
@section('title', 'Admin | Show Mahasiswa')
...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <a href="/admins/create" class="btn btn-primary my-3">Tambah Data Mahasiswa</a>
            ...
            <ul class="list-group">
                @foreach ($adstudents as $adnstudent)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  {{ $adnstudent -> nama}}
                  <a href="/admins/{{ $adnstudent -> id }}" class="badge badge-info"> Detail </a>
                </li>
                @endforeach
              </ul>
        </div>

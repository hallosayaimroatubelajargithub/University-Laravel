        ...
        <div class="col-6">            
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Hari    : {{$matkul->hari}}</p>
                  <p class="card-text">Pukul   : {{$matkul->pukul}}</p>
                  <p class="card-text">Ruang   : {{$matkul->ruang}}</p>              
                  <a href="/matkul" class="btn btn-warning">Kembali</a>
                </div>
              </div>

...
<div class="container">
    <div class="row">
        <div class="col-6">            
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">{{$adpegas->nama}}</h5>
                  <p class="card-text">Jenis Kelamin      : {{$adpegas->jk}}</p>
                  <p class="card-text">Jabatan            : {{$adpegas->jabatan}}</p>
                  
                  <a href="{{ $adpegas->id }}/edit" class="btn btn-primary">Edit</a>
                  <form action="/adpegas/{{ $adpegas->id }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
                    <button type="submit" class="btn btn-danger">Delete</button>
                  </form>
                  <a href="/adpegas" class="btn btn-warning">Kembali</a>
                </div>
              </div>

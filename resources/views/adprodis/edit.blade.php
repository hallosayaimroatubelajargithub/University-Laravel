...
@section('title', 'Admin | Form Ubah Prodi')
...
<div class="container">
    <div class="row">
        <div class="col-8">            
            <h3 class = "mt-3">Form Ubah Program Studi</h3>
            
                <form method="post" action="/adprodis/{{ $adprodis->id }}"><br>
                    @method('patch')
                    @csrf
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Masukkan Nama" name="nama" value="{{ $adprodis->nama }}">

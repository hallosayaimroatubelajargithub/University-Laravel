...
@section('title', 'Admin | Form Ubah Data Gedung')
...
<div class="container">
    <div class="row">
        <div class="col-8">            
            <h3 class = "mt-3">Form Ubah Data Gedung</h3>
            
                <form method="post" action="/adgedungs/{{ $adgedungs->id }}"><br>
                    @method('patch')
                    @csrf
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama Gedung</label>
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Masukkan Nama Gedung" name="nama" value="{{ $adgedungs->nama }}">
